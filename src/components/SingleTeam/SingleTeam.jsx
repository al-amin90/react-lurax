...
const SingleTeam = ({ team }) => {
    ...
    return (
        <div data-aos={animation} data-aos-delay={delay}
            ...
            <p className='text-gray-600 text-sm flex-grow mt-4'>{description}</p>
            <div className="flex items-center justify-center mt-6 gap-6 space-x-2">
                <div title="Twitter" className=" text-gray-600 cursor-pointer">
                ...
                <div title="LinkedIn" className=" text-gray-600 cursor-pointer">
                ...
                <div title="GitHub" className=" text-gray-600 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
