...
import person from '../../assets/member3.png'

const Footer = () => {
    return (
        <div className='text-white bg-[#0C1022]'>
            <footer className="py-20 max-w-7xl w-11/12 mx-auto">
                <div className="container py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 mb-20 text-sm gap-x-3 gap-y-8">
                        <div className="space-y-3 col-span-2">
                            ...
                            <h2 className="flex items-center gap-2 text-lg font-bold "><FaPhoneAlt />
                                +1 234 567 8901</h2>
                            <p className='link text-xs'>ijesun30@gmail.com</p>
                            <ul className="pt-5 *:cursor-pointer space-y-1">
                                <li>
                                    Features
                                </li>
                                <li>
                            ...
                            <p className='link font-bold text-sm '>CONTACT US</p>
                        ...
                        <div className="space-y-3 col-span-3">
                            ...
                            <div className="space-y-1 py-6 flex gap-4 items-center">
                                ...
                                <div className="text-lg font-bold">
                                    ...
                                    <h2 className="flex items-center gap-2  "><FaPhoneAlt />
                                        +1 234 567 8901</h2>
                                </div>
                            </div>
                            <p className="text-xs w-2/3">We love meeting new folks. If you do too, contact us by filling out the form, through email, or with a good old fashioned phone call.</p>
                            <div className="flex pt-3 justify-start space-x-3">
                ...
                <div className="space-y-3">
                    <div className="py-6 text-sm text-center text-white border-b">© 1968 Company Co. All rights reserved.</div>
                </div>
            </footer>
        </div>
    );
