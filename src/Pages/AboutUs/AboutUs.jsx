...
const AboutUs = () => {
    ...
    return (
        <div className='w-11/12 max-w-7xl mx-auto text-white'>
            <div>
                <h1 className='font-bold text-5xl mt-16 my-6'>Our story </h1>
                <p className='mb-16 w-full md:w-2/6'>Real Estate is one of the most experienced and respected companies. We have been in business for over 20 years and are always open to new experiences.</p>
